...
export class ItemDropGame extends Component {
    ...
    private dropItemAtPosition(targetX: number): void {
        ...
        this.currentPreviewItem.setPosition(new Vec3(targetX, currentPos.y, currentPos.z));
    ...
    private generateNextPreviewItem(): void {
        ...
        const previewPos = new Vec3(dividerWorldPos.x, dividerWorldPos.y + this.SPAWN_HEIGHT, 0);
